...
Note that we may broadly think of the \product{} as consisting of two independent parts: the Prompt Processing and Batch Production Services, which provide scheduling and workflow services, and the Science Payloads, which contain the algorithmic content.
...
A new ticket, \jira{DM-12967}, has been created to address the inadequacy of current requireents..
