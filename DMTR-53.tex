...
\setDocChangeRecord{
    ...
    \addtohist{1.1.1}{2018-02-07}{Typo in test specification name corrected}{G.~Dubois-Felsmann}
}
...
The test plan for \milestoneId{} involves the execution of the entire AG-00
